...
interface AddLabModalProps {
  isOpen: boolean
  onClose: () => void
  onSave: (lab: { name: string; email: string; mobile: string; address: string }) => void
}

export default function AddLabModal({ isOpen, onClose, onSave }: AddLabModalProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white w-full max-w-2xl rounded-sm overflow-hidden">
        ...
        <div className="bg-emerald-500 text-white px-6 py-4 flex justify-between items-center">
          <h2 className="text-xl font-medium">Add Lab Location</h2>
