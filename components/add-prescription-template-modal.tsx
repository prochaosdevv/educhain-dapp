...
interface AddPrescriptionTemplateModalProps {
  isOpen: boolean
  onClose: () => void
  onSave: (template: {
    name: string
...
export default function AddPrescriptionTemplateModal({ isOpen, onClose, onSave }: AddPrescriptionTemplateModalProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div ref={modalRef} className="bg-white w-full max-w-3xl rounded-sm overflow-hidden max-h-[90vh] overflow-y-auto">
        ...
        <div className="px-6 py-4 border-b sticky top-0 bg-white z-10">
          <h2 className="text-xl font-medium text-slate-700">Create Template</h2>
        </div>
