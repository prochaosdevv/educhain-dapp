...
interface AddCustomTemplateModalProps {
  isOpen: boolean
  onClose: () => void
  onSave: (template: { title: string; content: string; flags: string[] }) => void
}

export default function AddCustomTemplateModal({ isOpen, onClose, onSave }: AddCustomTemplateModalProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div ref={modalRef} className="bg-white w-full max-w-2xl rounded-sm overflow-hidden">
        ...
        <div className="bg-emerald-500 text-white px-6 py-4 flex justify-between items-center">
          <h2 className="text-xl font-medium">Add Custom Template</h2>
