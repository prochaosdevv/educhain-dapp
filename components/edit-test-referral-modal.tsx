...
interface EditTestReferralModalProps {
  isOpen: boolean
  onClose: () => void
  onSave: (referral: TestReferral) => void
  referral: TestReferral | null
}

export default function EditTestReferralModal({ isOpen, onClose, onSave, referral }: EditTestReferralModalProps) {
  ...
  useEffect(() => {
    if (referral) {
      setTestName(referral.testName)
      setDoctorName(referral.doctorName)
      setPatientName(referral.patientName)
      setDate(referral.date)
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white w-full max-w-2xl rounded-sm overflow-hidden">
        ...
        <div className="bg-emerald-500 text-white px-6 py-4 flex justify-between items-center">
          <h2 className="text-xl font-medium">Edit Test Referral</h2>
        ...
        <div className="p-6">
          <div className="space-y-6">
            <div>
              <label className="block text-sm text-gray-500 mb-1">Test Name</label>
              <Input
                value={testName}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-sm text-gray-500 mb-1">Patient Name</label>
                <Input
                  value={patientName}
