...
interface AddTestReferralModalProps {
  isOpen: boolean
  onClose: () => void
  onSave: (referral: {
    testName: string
...
export default function AddTestReferralModal({ isOpen, onClose, onSave }: AddTestReferralModalProps) {
  ...
  const handleSave = () => {
    onSave({ testName, doctorName, patientName, date, status })
    setTestName("")
    setDoctorName("")
    setPatientName("")
    setDate("")
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white w-full max-w-2xl rounded-sm overflow-hidden">
        ...
        <div className="bg-emerald-500 text-white px-6 py-4 flex justify-between items-center">
          <h2 className="text-xl font-medium">Add Test Referral</h2>
